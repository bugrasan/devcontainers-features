...
Installs GitHub Spec Kit's 'specify' CLI (Spec-Driven Development) via uv. Requires Python 3.11+ and uv to already be present.
...
|-----|-----|-----|-----|
| version | spec-kit release to install: 'latest' (newest release tag, resolved at build time) or an exact release tag like '0.12.11'. | string | latest |
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/bugrasan/devcontainers-features/blob/main/src/speckit/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
